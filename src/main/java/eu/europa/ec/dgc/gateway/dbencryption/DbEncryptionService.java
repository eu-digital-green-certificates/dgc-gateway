...
public class DbEncryptionService {
    ...
    private static final String PASSWORD_PROPERTY_NAME = "dgc_dbencryption_password";
        ...
        if (dbEncryptionPassword != null) {
            ...
            if (passwordLength != 16 && passwordLength != 24 && passwordLength != 32) {
                throw new ValidationException(
                    "Invalid Application Configuration: Database password must be a string with length of"
                        + " 16, 24 or 32");
            }
